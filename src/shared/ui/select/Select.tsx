    ...
    return (
      <div ref={containerRef} className={`relative w-full ${containerClassName}`}>
        ...
        <motion.button
          ...
          className={`bg-elevated text-text relative flex h-10 w-full cursor-pointer items-center justify-between rounded-2xl border px-4 py-0 text-left outline-none disabled:cursor-not-allowed disabled:opacity-50 ${className}`}
          disabled={disabled}
          id={selectId}
          name={name}
